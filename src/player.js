...
Player.prototype.create = function(frictionValue) {
  this.object = Body.create({ parts: this.bodyParts,
...
Player.prototype.jump = function() {
  if(keys[KEY_W] && this.isOnFloor){
      ...
      Body.applyForce(this.object,this.object.position,{x:0,y:force});
  };
};
...
Player.prototype.moveLeft = function() {
  if(keys[KEY_D]){
      ...
      Body.applyForce(this.object,this.object.position,{x:force,y:0});
  };
};
